...
export const MY = {
  ...
  'Something you asked for was turned down': 'သင် တောင်းဆိုထားသည့် အရာတစ်ခု ငြင်းပယ်ခံရသည်',
  '{n} things you asked for were turned down': 'သင် တောင်းဆိုထားသည့် အရာ {n} ခု ငြင်းပယ်ခံရသည်',
  'Read why, and ask again if it still needs doing': 'အကြောင်းရင်းကို ဖတ်ပြီး လိုအပ်သေးပါက ထပ်မံ တောင်းဆိုပါ',
...
export const MY_ERRORS = {
  ...
  SELLER_MUST_CONFIRM: 'ဤစာအုပ်သည် ရောင်းသူထံတွင် ရှိနေသေးသည် — ၎င်းတို့ကို စာရင်းသွင်းရန် တောင်းဆိုပါ',
  BOOK_NOT_WHOLE: 'ဤစာအုပ်သည် မပြည့်စုံတော့ပါ — လက်မှတ်အချို့ ရောင်းပြီးဖြစ်သည်။ ကျန်လက်မှတ်များကို တစ်ခုချင်း ရောင်းပါ',

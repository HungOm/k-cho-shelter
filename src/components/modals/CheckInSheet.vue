...
.who { padding: 8px 0 10px; border-bottom: 1px solid var(--line, #e3e3e3); }
...
.f.big { grid-column: 1 / -1; border-top: 1px solid var(--line, #e3e3e3); margin-top: 4px; padding-top: 6px; font-size: 1.05rem; }
...
.said { margin: 10px 0 0; padding-left: 10px; border-left: 2px solid var(--line, #e3e3e3); font-style: italic; }

.frozen { margin-top: 10px; padding-top: 4px; border-top: 1px dashed var(--line, #e3e3e3); }
